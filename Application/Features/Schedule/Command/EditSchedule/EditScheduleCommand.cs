...
namespace Application.Features.Schedule.Command.EditSchedule
{
    ...
    internal class EditScheduleCommandHandler : IRequestHandler<EditScheduleCommand, ScheduleResult<ScheduleCommandResponse>>
    {
        ...
        public EditScheduleCommandHandler(IMapper mapper, IScheduleRepository scheduleRepository,
        ...
        public async Task<ScheduleResult<ScheduleCommandResponse>> Handle(EditScheduleCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                var editSchedule = await _roomRepository.FindAsync(x => x.Id == request.Id && !x.IsDeleted);
                ...
                await _roomRepository.UpdateAsync(editSchedule);
        ...
        {
            var listConflictSchedule = _scheduleRepository.Entities.AsEnumerable().Where(x => request.Id != x.Id && request.RoomId == x.Id && !x.IsDeleted).
