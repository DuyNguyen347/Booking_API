...
namespace Application.Features.Film.Queries.GetById
{
    ...
    internal class GetFilmByIdQueryHandler : IRequestHandler<GetFilmByIdQuery, Result<GetFilmByIdReponse>>
    {
        ...
        public GetFilmByIdQueryHandler(IFilmRepository filmRepository, IFilmImageRepository filmImageRepository, IUploadService uploadService, ICategoryFilmRepository categoryFilmRepository, ICategoryRepository categoryRepository)
        {
